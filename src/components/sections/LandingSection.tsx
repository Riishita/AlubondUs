      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="group flex transform-gpu items-center gap-3 rounded-full border border-white/20 bg-white/10 px-6 py-3 text-[10px] uppercase tracking-[0.25em] text-white backdrop-blur-md hover:bg-white/20 md:px-8 md:py-4 md:text-xs shadow-[0_0_20px_rgba(255,255,255,0.05)]"
          >
            Discover Innovation ↓
          </motion.button>
        </motion.div>
        ...
        {/* RIGHT */}
        <motion.div 
          className="hidden flex-col items-end gap-10 md:flex"
          variants={VARIANTS.staggerContainer}
          initial="hidden"
          whileInView="show"
        ...
        >
          {stats.map((stat) => (
            <motion.div key={stat.label} variants={VARIANTS.framerFadeUp} className="text-right">
