...
const panels = [
  { video: "https://res.cloudinary.com/dnpdmq15v/video/upload/v1781784186/gemini_generated_video_9dff1758_t8e8fi.mp4", title: "Yas Island | Hotel on Yas Marina Circuit ", location: "W Abu Dhabi" },
