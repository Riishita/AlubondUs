    ...
    <section className="bg-black rounded-t-[3rem] -mt-12 relative z-20 pt-24 pb-32">
      <div className="max-w-[90rem] mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="relative">
          ...
          <button 
            onClick={() => scroll('left')}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform z-10 hidden md:flex"
            aria-label="Scroll left"
          >
            <svg className="w-5 h-5 text-black mr-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
