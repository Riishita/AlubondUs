...
const featuresText = [
  <h2 key="h" className="text-xl md:text-2xl font-bold text-gray-500 mb-4">Alubond A2 – Creating A Sustainable Future</h2>,
  <p key="p1">
...
const dimensionText = (
  <>
    ...
    <br/>
    <span className="text-xs">*Note: FR A2 Max Width 1500mm</span>
  </>
);
...
const technicalDataImages = Array.from({ length: 5 }).map((_, idx) => `https://picsum.photos/seed/techdataa2${idx}/500/700`);

const ProductDetailA2 = () => {
  return (
    <ProductDetailTemplate
      productName="Alubond A2"
      mainTitle="ALUBOND A2 - CREATING A SUSTAINABLE FUTURE"
      mainDescriptions={mainDescriptions}
      dimensionText={dimensionText}
      mainImageLeft="/products/FIRE RATED ALUMINIUM COMPOSITE PANELS 2.avif"
      mainImageRight="https://picsum.photos/seed/a2diagram2/600/400"
      toleranceText={toleranceText}
      advantagesText={advantagesText}
      finishColorText={finishColorText}
      featuresTitle="ALUBOND A2 - Features"
      featuresText={featuresText}
      featuresImage="https://picsum.photos/seed/a2diagram2/600/400"
      advantagesTabTitle="ALUBOND A2 - Advantages"
      technicalDataImages={technicalDataImages}
    />
  );
};

export default ProductDetailA2;
